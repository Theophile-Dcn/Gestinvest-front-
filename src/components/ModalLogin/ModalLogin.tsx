...
function ModalLogin({ closeModal }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-filter backdrop-blur-sm">
      ...
      <dialog
        open
        className="fixed top-2/4 left-2/4 bg-backgroundColorModal border border-white rounded-xl shadow-lg p-4 w-5/6 md:w-2/4 xl:w-2/5 2xl:w-2/6 transform -translate-x-2/4 -translate-y-2/4"
      >
